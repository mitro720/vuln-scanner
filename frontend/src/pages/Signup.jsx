...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSuccessMsg(res.message || 'Registration successful. Account pending admin approval.')
            setTimeout(() => {
                navigate('/login')
            }, 3000)
        } catch (err) {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center bg-[#050505] overflow-hidden relative">
            ...
            <div className="z-10 w-full max-w-md px-6">
                {/* Logo Area */}
                <div className="flex flex-col items-center mb-8 transition-all duration-700 transform hover:scale-105">
                    <div className="w-16 h-16 bg-gradient-to-tr from-purple-600 to-blue-500 rounded-2xl flex items-center justify-center shadow-[0_0_50px_rgba(147,51,234,0.3)] mb-4">
                        <Shield className="text-white w-8 h-8" />
                    </div>
                    <h1 className="text-3xl font-black bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-500 tracking-tighter">
                        SECURE<span className="text-purple-500">SCAN</span>
                    </h1>
                    <p className="text-gray-500 text-xs mt-2 font-medium uppercase tracking-[0.2em]">Request Operative Access</p>
                </div>
                ...
                <div className="bg-white/[0.03] backdrop-blur-xl border border-white/[0.08] rounded-3xl p-8 shadow-2xl relative overflow-hidden group">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        {successMsg && (
                            <div className="bg-green-500/10 border border-green-500/20 text-green-400 p-4 rounded-xl flex items-center gap-3 animate-in fade-in slide-in-from-top-4 duration-300">
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Username Reference</label>
                            <div className="relative group/input">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white/[0.05] border border-white/[0.1] text-white rounded-2xl py-3 pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 transition-all duration-300 placeholder:text-gray-600"
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group/input">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white/[0.05] border border-white/[0.1] text-white rounded-2xl py-3 pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all duration-300 placeholder:text-gray-600"
                                    placeholder="••••••••"
                                    required
                                />
                            </div>
                    ...
                    <div className="mt-8 flex justify-between items-center px-2">
                        ...
                        <Link to="/login" className="text-purple-400 text-xs font-bold uppercase tracking-widest hover:text-purple-300 transition-colors">
                            Return to Login
                        </Link>
                    </div>
                </div>
